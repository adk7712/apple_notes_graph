...
const Graph = ({ data, onNodeClick, edgeThickness = 1.0 }) => {
  ...
  const stylesheet = useMemo(() => [
    {
      ...
      style: {
        ...
        'font-size': '10px',
        'min-zoomed-font-size': '40px', // Hide until deep zoom
        ...
        'border-opacity': 0.5,
        'text-wrap': 'ellipsis',
        'text-max-width': '80px' // Prevent long labels from overlapping too much
      }
    },
    {
      ...
      style: {
        ...
        'border-color': '#0071e3',
        'border-opacity': 1,
        'min-zoomed-font-size': '0px' // Always show label for selected node
      }
    },
    {
      selector: 'node:active',
      style: {
        'overlay-color': '#0071e3',
        'overlay-opacity': 0.1,
        'overlay-padding': '8px'
      }
    },
  ...
  useEffect(() => {
    ...
    const layout = cy.layout({
      ...
      springCoeff: edge => 0.0005, // Softer springs
      springLength: edge => 100, // Longer edges
      theta: 0.66,
